...
import (
	...
	"github.com/catalystcommunity/sprinkles/server/storage/postgres"
...
var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start and serve the sprinkles api",
...
func registerServices() {
	var apiServer sprinklesv1.ApiServer = &handlers.ApiServer{}
	sprinklesv1.RegisterApiServer(Server.Server, apiServer)
}
...
func runGateway() {
	...
	err := sprinklesv1.RegisterApiHandlerFromEndpoint(context.Background(), mux, grpcAddress, opts)
